# -*- coding: utf-8 -*-
"""
Created on Wed Mar 30 16:14:20 2022
...
def convergencia(it, n):
    if it < 1000:
        ...
        print('Ejercicio', n)
        print('La toleracia en la norma del gradiente de f no se ha alcanzado en 1000 iteraciones.')
        print('x1000 =', xk)
        print('f(x1000) =', f(xk))
        print('norma(grad_f(x1000)) =', np.linalg.norm(grad_f_xk))
        print()
